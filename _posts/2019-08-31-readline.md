...
line by line with the following code?
...
export class ReadLine {
    ...
    */
    ...
    // see more at: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for-await...of
    async *lines() {
        let remnantBytes;
        ...
        for (let offset = 0; offset < this.fileSize; offset += this.chunkSize) {
            ...
            // check if we landed not at the beginning of an UTF-8 character byte sequence
